...
void lfb_print(int x, int y, char *s)
{
    ...
    unsigned char* c = (unsigned char*)&_binary_fonts_font_psf_start;
    // draw next character if it's not zero

    char str[2] = {0, '\0'};
    while(*s) {
        // get the offset of the glyph. Need to adjust this to support unicode table
        unsigned char *glyph = (unsigned char*)&_binary_fonts_font_psf_start +
...
// {
//     // get our font
//     sfn_t *font = (sfn_t*)&_binary_fonts_font_sfn_start;
